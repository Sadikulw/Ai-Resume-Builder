...
<div className="text-center mb-10 px-4"  >
  ...
  font-bold tracking-tight text-zinc-900 mb-4 leading-tight">

    What Users Say About Our
    <span className="text-blue-600"> AI Resume Builder</span>
  ...
  max-w-xl mx-auto leading-relaxed">
    ...
    Real feedback from students, professionals, and job seekers
    who created modern ATS-friendly resumes and landed interviews faster.
